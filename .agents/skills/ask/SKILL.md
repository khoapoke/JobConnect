...
4. **Reference BRIEF.md and AGENTS.md** when the question touches architecture, conventions, or feature scope.
...
1. **Read AGENTS.md** — coding rules, architecture, naming conventions, forbidden patterns.
...
→ Reference: `AGENTS.md` §Architecture Rules, `BRIEF.md` §5 Kiến trúc
...
→ Reference: `BRIEF.md` §7 Database Schema, `AGENTS.md` §Supabase Rules
...
→ Reference: `AGENTS.md` §Code Style, §Naming Conventions, §Approved Packages
