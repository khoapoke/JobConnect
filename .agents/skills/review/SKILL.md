...
1. **Review against AGENTS.md** as the source of truth for all conventions.
...
1. **Read AGENTS.md** — all rules sections.
...
### 4. Forbidden Patterns (AGENTS.md §Forbidden)
