...
1. **Follow AGENTS.md naming conventions exactly.** No exceptions.
...
4. **Never add packages** not in the approved list (AGENTS.md §Approved Packages).
...
1. **Read AGENTS.md** — architecture rules, naming, folder conventions.
